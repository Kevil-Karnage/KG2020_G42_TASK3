...
public class ScreenConverter {
    ...
    public int screenToRealWidth(int width) {
        return (int) (width * w / screenW);
    }

    public int screenToRealHeight(int height) {
        return (int) (height * h / screenH);
    }

    public int realToScreenWidth(double width) {
        return (int) (width * screenW / w);
    }

    public int realToScreenHeight(double height) {
        return (int) (height * screenH / h);
    }

    public int realTOScreenX(double X) {
        return (int) ((X - x) * screenW / w);
    }

    public int realToScreenY(double Y) {
        return (int) ((Y - y) * screenH / h);
    }

    public double screenTORealX(int X) {
        return X * w / screenW + x;
    }

    public double screenTORealY(int Y) {
